...
var EXTRA_PHRASES = [
  ...
  ["Türkiye geneli tedarik", "Nationwide supply in Turkey", "توريد في جميع أنحاء تركيا", "Lieferung in der gesamten Türkei", "터키 전역 공급"],
  ["Antep fıstığı ezme ve krema: kavrulmuş, doğal ve kremamsı çeşitler", "Pistachio paste and cream: roasted, natural and creamy varieties", "معجون وكريمة فستق: أصناف محمصة وطبيعية وكريمية", "Pistazienpaste und -creme: geröstete, natürliche und cremige Sorten", "피스타치오 페이스트·크림: 로스팅·천연·크리미 제품"],
  ["Seçilmiş Antep fıstığından üretilen", "made from selected pistachios", "منتج من فستق مختار", "hergestellt aus ausgewählten Pistazien", "엄선 피스타치오로 생산"],
  ["Tillo Tarim ürünleri seçilmiş hammaddeden, katkısız ve izlenebilir üretim anlayışıyla modern tesislerimizde hazırlanır. Toptan sipariş ve numune talepleri için iletişim sayfamızdan bize ulaşabilirsiniz.", "Tillo Tarim products are prepared at our facilities from selected ingredients with an additive-free, traceable approach. For wholesale orders and samples, contact us via our contact page.", "تُحضَّر منتجات تيلو تاريم في منشآتنا من مواد خام مختارة بإنتاج قابل للتتبع. للطلبات بالجملة والعينات تواصلوا معنا عبر صفحة الاتصال.", "Tillo Tarim-Produkte werden in unseren Anlagen aus ausgewählten Rohstoffen nachvollziehbar und möglichst ohne Zusatzstoffe hergestellt. Für Großbestellungen und Muster kontaktieren Sie uns über die Kontaktseite.", "Tillo Tarim 제품은 엄선 원료로 시설에서 무첨가·이력 추적 생산합니다. 도매·샘플 문의는 문의 페이지를 이용해 주세요."]
];
